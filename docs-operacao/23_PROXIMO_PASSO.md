...
Pasta `docs-operacao/FalhasCorrigidas/` — **45 falhas documentadas (FC001–FC045)** + bug published_store (sem número FC — corrigido via migration 036, não foi incidente de produção).
Próximo número disponível: **FC046**.
