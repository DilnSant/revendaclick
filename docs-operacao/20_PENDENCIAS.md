...
| CONCLUÍDA | FalhasCorrigidas/ — histórico permanente de bugs | — | 31 falhas documentadas em `docs-operacao/FalhasCorrigidas/` (FC001–FC031) com causa raiz, correção, commits e prevenção |
