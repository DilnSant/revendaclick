...
| PENDENTE | **Deploy do D39** | **Alta** | Correção do canonical/sitemap está commitada mas **não enviada**. Enquanto não subir, produção segue com o canonical apontando para URL que responde 307 e as 6 rotas fora do sitemap |
