...
| CONCLUÍDA | FalhasCorrigidas/ — histórico permanente de bugs | — | 32 falhas documentadas em `docs-operacao/FalhasCorrigidas/` (FC001–FC032) com causa raiz, correção, commits e prevenção |
